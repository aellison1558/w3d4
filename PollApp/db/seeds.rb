...
ActiveRecord::Base.transaction do
  ...
  User.create!(id: 1, name: 'Glen')
  User.create!(id: 2, name: 'Steve')
  User.create!(id: 3, name: 'Philbert')
  User.create!(id: 4, name: 'Todd')
  User.create!(id: 5, name: 'Cylinda')
  User.create!(id: 6, name: 'Jovonne')
  User.create!(id: 7, name: 'Ithuana')
  User.create!(id: 8, name: 'Modesa')
  User.create!(id: 9, name: 'Levi')
